...
public class Vista_Carrito extends AppCompatActivity {
...
// Definir la consulta SQL para obtener todos los datos de la tabla "productos"
        String consulta = "SELECT productos.idproducto,nombreproducto,precio,inventario from tiendas,tiepro,productos,clipro,clientes where tiendas.idtienda = tiepro.idtienda and tiepro.idproducto = productos.idproducto and productos.idproducto = clipro.idproducto and clipro.idcliente = clientes.idcliente and clientes.idcliente ="+text;
            ...
            do {
                ...
                boton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(Vista_Carrito.this, Vista_Cliente.class);
...
// Cerrar el cursor y la conexión a la base de datos
    ...
    public void carro(){
        Intent intent = new Intent(Vista_Carrito.this, Vista_Productos.class);
        intent.putExtra(EXTRA_TEXT, text);
        startActivity(intent);
    }
    public void salir(){
        Intent intent = new Intent(Vista_Carrito.this, MainActivity.class);
        startActivity(intent);
    }
}